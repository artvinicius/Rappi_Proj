...
public class Compras extends Niveis {
	...
	public void classificacao(double pontuacao) {
		...
		if (this.pontuacao < 2000) {
			...
			System.out.println("Sua Classificacao e BRONZE - Total de pontos: " + pontuacao);

		}

		if (this.pontuacao >= 2000 && this.pontuacao < 4000) {

			System.out.println("Sua Classificacao e SILVER - Total de pontos: " + pontuacao);

		}

		if (this.pontuacao >= 4000 && this.pontuacao < 10000) {

			System.out.println("Sua Classificacao e GOLD - Total de pontos: " + pontuacao);

		}

		if (this.pontuacao >= 10000) {

			System.out.println("Sua Classificacao e DIAMANTE - Total de pontos: " + pontuacao);
